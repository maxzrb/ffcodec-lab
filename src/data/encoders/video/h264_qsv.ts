...
export const h264Qsv: EncoderDefinition = {
  ...
  specialParameters: [
    // -- 异步与功耗 ----------------------------------------------
    {
      id: 'h264_qsv.asyncdepth', label: '异步深度 (-async_depth)',
      control: 'number',
    ...
    {
      id: 'h264_qsv.lowpower', label: '低功耗模式 (-low_power)',
      control: 'switch',
    ...
    // -- B / GOP（通用编码选项） ---------------------------------
    {
      id: 'h264_qsv.bf', label: '最大 B 帧数 (-bf)',
      control: 'number',
    ...
    {
      id: 'h264_qsv.refs', label: '参考帧数 (-refs)',
      control: 'number',
    ...
    // -- 自适应帧控制 --------------------------------------------
    {
      id: 'h264_qsv.adaptiveI', label: '自适应 I 帧 (-adaptive_i)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.adaptiveB', label: '自适应 B 帧 (-adaptive_b)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.bStrategy', label: 'B 帧策略 (-b_strategy)',
      control: 'select',
    ...
    // -- 帧内刷新 ------------------------------------------------
    {
      id: 'h264_qsv.idrInterval', label: 'IDR 帧间隔 (-idr_interval)',
      control: 'number',
    ...
    {
      id: 'h264_qsv.intRefType', label: '帧内刷新类型 (-int_ref_type)',
      control: 'select',
    ...
    {
      id: 'h264_qsv.intRefCycleSize', label: '帧内刷新周期 (-int_ref_cycle_size)',
      control: 'number',
    ...
    // -- 尺寸与熵编码 --------------------------------------------
    {
      id: 'h264_qsv.cavlc', label: 'CAVLC 熵编码 (-cavlc)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.maxFrameSize', label: '最大帧大小 bytes (-max_frame_size)',
      control: 'number',
    ...
    {
      id: 'h264_qsv.maxSliceSize', label: '最大 Slice 大小 bytes (-max_slice_size)',
      control: 'number',
    ...
    // -- 码率控制与场景 ------------------------------------------
    {
      id: 'h264_qsv.mbbrc', label: '宏块级码控 (-mbbrc)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.scenario', label: '使用场景 (-scenario)',
      control: 'select',
    ...
    {
      id: 'h264_qsv.avbrAccuracy', label: 'AVBR 精度 (-avbr_accuracy)',
      control: 'number',
    ...
    {
      id: 'h264_qsv.avbrConvergence', label: 'AVBR 收敛速度 (-avbr_convergence)',
      control: 'number',
    ...
    // -- SEI 与输出格式 ------------------------------------------
    {
      id: 'h264_qsv.picTimingSei', label: 'pic_timing SEI (-pic_timing_sei)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.recoveryPointSei', label: 'Recovery Point SEI (-recovery_point_sei)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.repeatPps', label: '每帧重复 PPS (-repeat_pps)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.singleSeiNalUnit', label: '单 SEI NAL 单元 (-single_sei_nal_unit)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.vcm', label: 'VCM 模式 (-vcm)',
      control: 'switch',
    ...
    {
      id: 'h264_qsv.rdo', label: 'RDO 级别 (-rdo)',
      control: 'number',
