...
import type { ProjectConfig } from '../apps/web/src/domain/config/project-config'
import { createDefaultProjectConfig } from '../apps/web/src/domain/config/defaults'
import { loadCatalog } from '../apps/web/src/domain/catalog/catalog-loader'
import { normalizeConfig } from '../apps/web/src/domain/normalization'
import { RuleIndex } from '../apps/web/src/domain/rules/rule-index'
import { evaluateRules } from '../apps/web/src/domain/rules/rule-evaluator'
import { validateConfig } from '../apps/web/src/domain/validation'
import { buildCommandPlan } from '../apps/web/src/domain/command/command-builder'
import { renderBash, renderPowerShell, renderCmd } from '../apps/web/src/domain/shell'
