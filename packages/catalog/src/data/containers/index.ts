...
const webp: ContainerDefinition = { id: 'webp', label: 'WebP', extension: 'webp', category: 'image', videoCodecs: { ...videoNone(), libvpx: 'supported' as CompatibilityLevel }, audioCodecs: audioNone(), subtitleCodecs: noSubtitles(), muxerArguments: [], sourceRefs: [] }
const avif: ContainerDefinition = { id: 'avif', label: 'AVIF', extension: 'avif', category: 'image', videoCodecs: { ...videoNone(), libsvtav1: 'supported' as CompatibilityLevel, libaom_av1: 'supported' as CompatibilityLevel }, audioCodecs: audioNone(), subtitleCodecs: noSubtitles(), muxerArguments: [], sourceRefs: [] }
