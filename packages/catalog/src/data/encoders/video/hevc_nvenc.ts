...
export const hevcNvenc: EncoderDefinition = {
  ...
  specialParameters: [
    {
      id: 'hevc_nvenc.gpu', label: 'GPU 设备索引 (-gpu)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.rclookahead', label: '码率控制前瞻 (-rc-lookahead)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.lookaheadLevel', label: '前瞻等级 (-lookahead_level)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.spatialaq', label: '空间 AQ (-spatial-aq)',
      control: 'switch',
    ...
    {
      id: 'hevc_nvenc.aqStrength', label: '空间 AQ 强度 (-aq-strength)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.temporalaq', label: '时间 AQ (-temporal-aq)',
      control: 'switch',
    ...
    {
      id: 'hevc_nvenc.bf', label: '最大 B 帧数 (-bf)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.bRefMode', label: 'B 帧参考模式 (-b_ref_mode)',
      control: 'select',
    ...
    {
      id: 'hevc_nvenc.noScenecut', label: '关闭场景检测 (-no-scenecut)',
      control: 'switch',
    ...
    {
      id: 'hevc_nvenc.forcedIdr', label: '强制 IDR 关键帧 (-forced-idr)',
      control: 'switch',
    ...
    {
      id: 'hevc_nvenc.strictGop', label: '严格 GOP 结构 (-strict_gop)',
      control: 'switch',
    ...
    {
      id: 'hevc_nvenc.coder', label: '熵编码器 (-coder)',
      control: 'select',
    ...
    {
      id: 'hevc_nvenc.delay', label: '编码延迟帧数 (-delay)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.initQpP', label: '初始 P 帧 QP (-init_qpP)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.initQpB', label: '初始 B 帧 QP (-init_qpB)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.initQpI', label: '初始 I 帧 QP (-init_qpI)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.qpCbOffset', label: 'Cb QP 偏移 (-qp_cb_offset)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.qpCrOffset', label: 'Cr QP 偏移 (-qp_cr_offset)',
      control: 'number',
    ...
    {
      id: 'hevc_nvenc.weightedPred', label: '加权预测 (-weighted_pred)',
      control: 'select',
