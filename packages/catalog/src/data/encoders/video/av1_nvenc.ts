...
export const av1Nvenc: EncoderDefinition = {
  ...
  specialParameters: [
    ...
    // -- 自适应量化 ----------------------------------------------
    {
      id: 'av1_nvenc.spatialAq', label: '空间 AQ (-spatial-aq)',
      control: 'switch',
    ...
    {
      id: 'av1_nvenc.aqStrength', label: '空间 AQ 强度 (-aq-strength)',
      control: 'number',
      ...
      explanationId: 'expl.nvenc.aqStrength', sourceRefs: [nvencAv1Source],
    },
    {
      id: 'av1_nvenc.temporalAq', label: '时间 AQ (-temporal-aq)',
      control: 'switch',
