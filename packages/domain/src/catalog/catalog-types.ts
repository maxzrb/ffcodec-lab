...
export const CODEC_CATEGORIES: CodecCategoryDef[] = [
  ...
  { id: 'av2', label: 'AV2', families: [], placeholder: true, placeholderNote: 'AV2 正式规范已于 2025 年 5 月由 AOMedia 发布，但截至 FFmpeg 9.0 发行版，上游尚未合并任何 AV2 编码器。保留以等待 FFmpeg 实现。' },
  ...
  { id: 'avs3', label: 'AVS3', families: ['avs3'], placeholder: true, placeholderNote: '截至 FFmpeg 9.0 发行版，编码器 uavs3e 未合并入上游。FFmpeg 仅可通过外部库解码 AVS3，编码需自行打补丁编译。' },
